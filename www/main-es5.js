...
var PlanPage = /** @class */ (function () {
    ...
    PlanPage.prototype.presentToast = function (msg, color) {
    ...
    PlanPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    PlanPage.prototype.dismissModal = function () {
        this.modalController.dismiss({
            'dismissed': true
        });
    };
    PlanPage.prototype.confirmPayment = function (sec) {
        this.presentToast("Success", "success");
    };
    PlanPage.prototype.setupStripe = function () {
        var _this = this;
        ...
        form.addEventListener('submit', function (event) {
            ...
            _this.stripe.createPaymentMethod({
                type: 'card',
                card: _this.card,
                billing_details: {
                    email: _this.email,
                ...
                if (result.error) {
                    ...
                    _this.subService.createSubscription(_this.email, result.paymentMethod.id, _this.value, _this.userid)
                        .subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var latest_invoice, payment_intent, client_secret, status_1;
                        var _this = this;
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!payment_intent) return [3 /*break*/, 3];
                                    client_secret = payment_intent.client_secret, status_1 = payment_intent.status;
                                    if (!(status_1 === 'requires_action')) return [3 /*break*/, 1];
                                    this.stripe.confirmCardPayment(client_secret)
                                        ...
                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    console.log(result);
                                                    return [4 /*yield*/, this.presentToast("Success", "success")];
                                                case 2:
                                                    _a.sent();
                                                    this.dismissModal();
                                                    //   this.navCtrl.back()
                                    ...
                                    return [3 /*break*/, 3];
                                case 1: return [4 /*yield*/, this.presentToast("Success", "success")];
                                case 2:
                                    _a.sent();
                                    this.dismissModal();
                                    //  this.navCtrl.back()
...
var SubscriptionPage = /** @class */ (function () {
    ...
    SubscriptionPage.prototype.presentToast = function (msg, color) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SubscriptionPage.prototype.dismissModal = function () {
        this.modalController.dismiss({
            'dismissed': true
        });
    };
    ...
    SubscriptionPage.prototype.setupStripe = function () {
        var _this = this;
        var elements = this.stripe.elements();
        var style = {
            base: {
        ...
        form.addEventListener('submit', function (event) {
            ...
            _this.stripe.createPaymentMethod({
                ...
                if (result.error) {
                    ...
                    console.log("cusid" + _this.value);
                    _this.subService.updatePayment(result.paymentMethod.id, _this.value)
    ...
    SubscriptionPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
...
var SubscriptionService = /** @class */ (function () {
    ...
    SubscriptionService.prototype.getStatus = function (userid) {
        var statusURl = _config_config__WEBPACK_IMPORTED_MODULE_3__["config"].nodeURL + "/data";
    ...
    SubscriptionService.prototype.getSubscription = function (subscriptionId) {
        var subsURL = _config_config__WEBPACK_IMPORTED_MODULE_3__["config"].nodeURL + "/subscription";
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('subscriptionId', subscriptionId);
        return this.http.get(subsURL, { params: params });
    };
    SubscriptionService.prototype.createSubscription = function (email, id, value, userid) {
        var subscreationURL = _config_config__WEBPACK_IMPORTED_MODULE_3__["config"].nodeURL + "/create-customer";
        return this.http
    ...
    SubscriptionService.prototype.updatePayment = function (paymentmethod, customerId) {
        var paymentupdateURL = _config_config__WEBPACK_IMPORTED_MODULE_3__["config"].nodeURL + "/updatePayment";
        return this.http
    ...
    SubscriptionService.prototype.deleteSubscription = function (email, userid, subid, cusid, value) {
        var subsURL = _config_config__WEBPACK_IMPORTED_MODULE_3__["config"].nodeURL + "/subscription";
        return this.http
            .post(subsURL, {
            email: email,
